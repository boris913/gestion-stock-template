...
<div id="stockModal" class="modal">
    <div class="modal-content">
        ...
        <ul class="list-group modal-ul">
            <?php foreach($lowStockProducts as $product): ?>
                <li class="list-group-item">
                    <a href="http://gestionstock/addpurchase.php">
        ...
        <button type="button" class="btn btn-secondary" onclick="window.location.href='http://gestionstock/addpurchase.php'">Ajouter en stock</button>
      </div>
        </div>
